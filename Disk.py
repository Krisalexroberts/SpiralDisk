...
def create_html_visualization(data, output_file="disk_visualization.html"):
    ...
    <body>
        ...
        <script>
            ...
            console.log(`Root node: ${data.name}`);
            console.log(`Size: ${data.human_size}`);
            console.log(`Children: ${data.children ? data.children.length : 0}`);
            
            // Set up dimensions - make it responsive and fill most of the screen
            const getChartDimensions = () => {
                const container = document.getElementById("container");
                const visualizationDiv = document.getElementById("visualization");
                // Use at least 80% of the available width and height
                const width = Math.max(visualizationDiv.clientWidth * 0.8, window.innerWidth * 0.6);
                const height = Math.max(visualizationDiv.clientHeight * 0.8, window.innerHeight * 0.6);
            ...
            // Create the SVG container with larger initial sizing
            ...
            console.log("Hierarchy created with depth:", root.height);
